  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 flex-col p-4">
        <h3 className="font-heading text-base font-bold uppercase leading-tight tracking-wide text-charcoal sm:text-lg">
          {pick(item.name)}
        </h3>
        ...
        <div className="mt-4 flex items-center justify-between">
          ...
          <motion.button
            ...
            className={`relative grid h-11 w-11 place-items-center rounded-2xl text-white shadow-soft transition-colors ${
